...
def ta_input_splitter(x=0, y=0, angle=0, mirror=optomech.mirror_mount_k05s2, x_split=False, thumbscrews=True):
    ...
    # Define beam path:
    beam = baseplate.add_beam_path(x=base_dx-start_x-5, y=start_y+10, angle=layout.cardinal['left'], color = (0,0,255))


    # Optic Placement Definitions:
    baseplate.place_element("evalminiTA", optomech.eval_miniTA, x=base_dx-start_x-5, y=start_y+10, angle=layout.cardinal['left'])
    ...
    baseplate.place_element_along_beam("pinhole1", optomech.circular_lens, beam, 
                                       beam_index=0b1, distance=40-5, angle=90, mount_type=optomech.mirror_mount_c05g)
    baseplate.place_element_along_beam("mirror2_in", optomech.circular_mirror, beam,
                                       beam_index=0b1, distance=15, angle=180-225,
                                       mount_type=optomech.mirror_mount_k05s2)
    ...
    baseplate.place_element_along_beam("pbs", optomech.cube_splitter, beam,
                                       beam_index=0b1, distance=20, angle=180-0, invert=False,
    ...
    baseplate.place_element_along_beam("pinhole2", optomech.circular_lens, beam,
                                       beam_index=0b10, distance=32, angle=180-180, mount_type=optomech.mirror_mount_c05g)
    baseplate.place_element_along_beam("mirror1_out", optomech.circular_mirror, beam,
                                       beam_index=0b10, distance=15, angle=180-45,
                                       mount_type=optomech.mirror_mount_k05s2)
    baseplate.place_element_along_beam("mirror2_out", optomech.circular_mirror, beam,
                                       beam_index=0b10, distance=25, angle=180-225,
                                       mount_type=optomech.mirror_mount_k05s2)
    ...
    baseplate.place_element_along_beam("fiberport_out_1", optomech.fiberport_mount_hca3, beam,
                                       beam_index=0b10, distance=15, angle=180-0)

    # Reflected pbs parts:
    baseplate.place_element_along_beam("mirror3_out", optomech.circular_mirror, beam,
                                       beam_index=0b11, distance=65, angle=180-(-45),
                                       mount_type=optomech.mirror_mount_k05s2)
    baseplate.place_element_along_beam("pinhole3", optomech.circular_lens, beam,
                                       beam_index=0b11, distance=28, angle=180-0, mount_type=optomech.mirror_mount_c05g)
    baseplate.place_element_along_beam("mirror4_out", optomech.circular_mirror, beam,
                                       beam_index=0b11, distance=20, angle=180-135,
                                       mount_type=optomech.mirror_mount_k05s2)
    baseplate.place_element_along_beam("waveplate1_out", optomech.waveplate, beam, 
                                       beam_index=0b11, distance=18, angle=180-270, 
                                       mount_type=optomech.rotation_stage_rsp05)
    baseplate.place_element_along_beam("fiberport_out_1", optomech.fiberport_mount_hca3, beam,
                                       beam_index=0b11, distance=10, angle=180-270)
